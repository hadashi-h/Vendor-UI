...
export function initialItems() {
    let items = [
        ...
        new Consumable(1, "Russian Dumpling", "consumable", 55, "A culinary masterpiece. Will boost my energy up to 15% by 30 minutes!", [6]),
        ...
        new CraftingMaterial(6, "Flour", "crafting", 37, "How do I eat this?"),
        ...
        new CraftingMaterial(9, "Piece of Iron", "crafting", 790, "It's hard to chew.")
    ]; 
    return items;
}
